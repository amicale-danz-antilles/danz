...
export default function Privacy() {
  return <main className="privacy-page">
    <div className="privacy-wrap">
      ...
      <section><h2>8. Cookies, stockage local et mode hors ligne</h2><p>Le site n’utilise pas de publicité ni de traceur publicitaire. Les éléments techniques conservés dans le navigateur servent uniquement à maintenir la connexion, les préférences du site et les fonctions nécessaires au service.</p><p>Afin d’assurer une consultation limitée lorsque la connexion Internet disparaît, l’application peut conserver sur l’appareil pendant au maximum <strong>12 heures</strong> la dernière copie autorisée de l’Accueil, de l’Agenda, des Bons plans, des Sondages, de l’index des Albums et du profil technique validé. Pour les albums, seules des miniatures légères peuvent être copiées localement ; une miniature trop volumineuse n’est pas enregistrée hors ligne. Les liens WeTransfer et les albums complets ne sont pas conservés dans cette copie locale.</p><p>Ce cache est cloisonné par utilisateur, ne contient ni la base complète des utilisateurs, ni les outils d’administration, ni les secrets techniques. Il est supprimé lors de la déconnexion. Toute opération qui modifie les données — vote, proposition, publication, administration ou téléchargement d’album — nécessite une connexion Internet.</p><p>L’ouverture d’un lien WeTransfer conduit vers un service externe soumis à sa propre politique de confidentialité et à ses propres choix de cookies.</p></section>
