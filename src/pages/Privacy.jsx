...
export default function Privacy() {
  return <main className="privacy-page">
    <div className="privacy-wrap">
      ...
      <div className="privacy-version">Version du 7 septembre 2026 · Infrastructure en cours de migration vers OVHcloud France.</div>
      ...
      <section><h2>5. Hébergement et sous-traitants</h2><p>À ce jour, l’interface est publiée via GitHub Pages, l’authentification et la base de données utilisent Supabase et une partie des médias utilise Cloudflare R2. Cette architecture est <strong>transitoire</strong>. Une migration vers une infrastructure OVHcloud localisée en France est engagée afin de renforcer la maîtrise et la localisation des données.</p><p>Tant que cette migration n’est pas terminée, certains traitements techniques peuvent être réalisés hors de France ou hors de l’Union européenne selon l’infrastructure des prestataires concernés.</p></section>

      <section><h2>6. Durée de conservation</h2><p>Les données de compte sont conservées pendant la durée nécessaire à l’accès à l’espace privé. Lorsqu’un accès n’est plus justifié, il peut être suspendu immédiatement puis supprimé. Les demandes d’inscription et journaux administratifs sont conservés uniquement le temps nécessaire au suivi et à la sécurité du service. Une politique de conservation chiffrée sera arrêtée avec le bureau avant la migration définitive OVH.</p></section>
      ...
      <section><h2>8. Cookies et traceurs</h2><p>Le site n’utilise pas de publicité ni de traceur publicitaire. Les éléments techniques conservés dans le navigateur servent uniquement à maintenir la connexion, les préférences du site et les fonctions nécessaires au service.</p></section>

      <section><h2>9. Photos et vidéos</h2><p>Les médias des événements sont accessibles uniquement aux membres autorisés. Une demande de retrait d’une photo ou vidéo représentant une personne peut être adressée au bureau afin qu’elle soit examinée et, le cas échéant, retirée de l’album concerné.</p></section>
