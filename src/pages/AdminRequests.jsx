...
export default function AdminRequests() {
  ...
  const tools = [
    ...
    ['/administration/contenus', '✍️', 'Publications', 'Créer, modifier, programmer, dépublier ou supprimer actualités, événements et albums.'],
    ['/notifications', '🔔', 'Notifications', 'Gérer vos notifications personnelles et les autorisations globales du site.'],
