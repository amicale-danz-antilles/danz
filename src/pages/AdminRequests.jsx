...
export default function AdminRequests() {
  ...
  const tools = [
    ...
    ['/administration/contenus', '✍️', 'Publications & notifications', 'Créer, modifier, programmer, dépublier ou supprimer actualités, événements et albums, avec leurs notifications.'],
